//write a program for Open the file and read its contents,Count the number of lines in the file,Count the number of words in the file,Close the file after processing.
